...
function PaymentContent() {
  ...
  function validate() {
    ...
    if (parts.length !== 2 || !parts[0] || !parts[1] || parseInt(parts[0]) > 12 || parseInt(parts[0]) < 1) {
      e.expiry = 'Geçerli bir son kullanma tarihi girin (AA/YY).';
    }
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      // Iyzico 3D Secure HTML döndüyse göster
  ...
  // Görsel kart için gösterim değerleri
    ...
    <div style={{ maxWidth: 700, margin: '2rem auto', padding: '0 1rem' }}>
      ...
      <div className="stepper" style={{ marginBottom: '2rem' }}>
        {['Sefer Seç', 'Koltuk Seç', 'Yolcu Bilgileri', 'Ödeme'].map((step, i) => (
          <div key={step} className={`stepper__step${i === 3 ? ' active' : ' done'}`}>
            <div className="stepper__circle">{i < 3 ? '✓' : 4}</div>
      ...
      <div className="form-card">
        ...
        <div style={{
          ...
          <div>
            <div style={{ fontSize: '0.7rem', color: '#6C757D', fontWeight: 600, letterSpacing: '1px' }}>
              BİLET PNR
            </div>
        ...
        <div className="payment-card">
          ...
          <div className="payment-card__number">{displayNumber}</div>
          ...
          <div className="form-grid">
            ...
            <div className="form-group" style={{ gridColumn: '1 / -1' }}>
              ...
              <span style={{ fontSize: '0.75rem', color: '#ADB5BD', marginTop: '4px' }}>
                🧪 Sandbox test kartı: <code style={{ background: '#F8F9FA', padding: '1px 4px', borderRadius: '3px' }}>5528790000000008</code>
              </span>
            </div>
